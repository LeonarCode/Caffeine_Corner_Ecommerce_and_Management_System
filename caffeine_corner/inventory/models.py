...
class Inventory(models.Model):
    ...
    unit              = models.CharField(max_length=20)          # e.g. kg, L, pcs
    ...
    def quantity_available(self):
        """quantity_on_hand minus what's reserved."""
...
# ─────────────────────────────────────────────────────────────────────────────
# Stock Movement  (every in/out is recorded here)
# ─────────────────────────────────────────────────────────────────────────────
...
class StockMovement(models.Model):
    ...
    # Positive = stock in, Negative = stock out (computed on save)
    ...
    def save(self, *args, **kwargs):
        # Stock-in types add to inventory, stock-out types subtract
...
# ─────────────────────────────────────────────────────────────────────────────
# Ingredient  (links a Product to its inventory items)
# ─────────────────────────────────────────────────────────────────────────────
